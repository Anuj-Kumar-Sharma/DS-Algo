...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		//Lets suppose the student class do not extend the comparable then we can sort it using comparator class in this way
				...
				//LETS SUPPOSE I DONT WANT TO MAKE A SEPARATE NEW CLASS FOR COMPARATOR, THEN HOW CAN WE DO IT???
	...
	//AFTER JAVA -8 , LAMBDA FUNCTION INTRODUCED WHICH MAKE THIS ABOVE THING MORE EASY
...
/*
 * ACCORDING TO LAMBDA FUNCTION , If we already know that the next argument is gonna be comparator, then we can ignore writing it
 * We already know that the method is going to be "compare" so we can also ignore it
 * the access modifiers and return type are also known so we can erase it too
 * just one addition "->" to define lambda function	
 * Object type can also be removed because it is already known that which type of object it gonna be			
 */
		...
		//IF WE WANT TO REVERSE THE DEFINED SORTING ORDER WE CAN USE "reversed" function
